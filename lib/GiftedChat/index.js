...
function GiftedChat(props) {
    ...
    messageIdGenerator = () => (Math.random() + 1).toString(36).substring(7), user = {}, onSend, locale = 'en', renderLoading, actionSheet, textInputProps, renderChatFooter, renderInputToolbar, keyboardBottomOffset = 0, focusOnInputWhenOpeningKeyboard = true, onInputTextChanged, inverted = true, minComposerHeight = MIN_COMPOSER_HEIGHT, maxComposerHeight = MAX_COMPOSER_HEIGHT, isKeyboardInternallyHandled = true, } = props;
    ...
    const renderMessages = useMemo(() => {
        ...
        <MessageContainer {...messagesContainerProps} inverted={inverted} messages={messages} forwardRef={messageContainerRef} isTyping={isTyping}/>
    ...
    const _onInputTextChanged = useCallback((text) => {
    ...
    useAnimatedReaction(() => isKeyboardInternallyHandled ? keyboard.height.value : 0, (value, prevValue) => {
        ...
        if (prevValue !== null && value !== prevValue) {
            ...
            if (isKeyboardMovingUp !== trackingKeyboardMovement.value) {
                ...
                keyboardBottomOffsetAnim.value = withTiming(isKeyboardMovingUp ? keyboardBottomOffset : 0, {
